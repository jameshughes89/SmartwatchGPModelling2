'''
Print out the accuracy table for a given GROUP_SIZE. 

This code is not done because the accuracies were so awful that I didn't bother. Not even worth showing. 
...
for time in times:
	...
	for gs in range(5, MAX_GROUP_SIZE + 1, 5):
		...
		for voters in range(NUM_VOTERS_START, NUM_VOTERS_STOP + 1):
			...
			fName = '3-AccMatSmall_'  + str(gs) + '_' + time + '.csv'
